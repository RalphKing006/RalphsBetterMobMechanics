...
public class Settings {
  ...
  public ConfigManager.SimpleConfig configuration = (new ConfigManager((JavaPlugin) MobAI.getInstance())).getNewConfig("Settings.yml");

  public Settings() {
    if (!this.configuration.contains("VersionTracking")) {
      this.configuration.set("VersionTracking", "true", "Set this to true/false to enable/disable version tracking");
    }
    if (!this.configuration.contains("Worlds")) {
      ...
      this.configuration.set("Worlds", list, new String[]{"Add all the worlds affected by Better MobAI here"});
    }
    if (!this.configuration.contains("BetterMobs")) {
      ...
      this.configuration.set("BetterMobs", list, new String[]{"Add all the mobs affected by Better MobAI here"});
    }
